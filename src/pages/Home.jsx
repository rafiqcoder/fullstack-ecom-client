  ...
  const heroSlides = [
    {
      ...
      description:
        "Our advanced AI algorithms help you find exactly what you're looking for",
      image:
    ...
    },
    {
      ...
      subtitle: "Curated collection of excellence",
      description:
            ...
            <div className="relative h-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white max-w-4xl mx-auto px-4">
                  ...
                  <button className="bg-white text-gray-800 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
                    {slide.buttonText}
                  </button>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our AI-curated selection of premium products, chosen
